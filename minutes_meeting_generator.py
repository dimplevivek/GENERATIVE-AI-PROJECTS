...
Original file is located at
    https://colab.research.google.com/drive/1TAFKLDKVcIuI_Uent6uJ_cDlEjmcdBhU
"""
...
agenda = input ("Enter tion inageda points (comma separated): ")

decisions = input ("Enter decisions taken (comma separated): ")

action_items = input("Enter actems (comma separated): ")
